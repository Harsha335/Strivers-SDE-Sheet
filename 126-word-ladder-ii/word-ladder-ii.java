class Solution {
  ...
  private void setMinLengthBFS(boolean[][] adjMat, int[] ladderLength) {
  ...
  private List < List < String >> getMinTransformSeqs(List < String > nodes, boolean[][] adjMat, int[] ladderLength, int pos, int dist) {
